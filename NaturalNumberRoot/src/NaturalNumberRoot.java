...
public final class NaturalNumberRoot {
    ...
    public static void root(NaturalNumber n, int r) {
        ...
        NaturalNumber subtraction = new NaturalNumber2(tooHigh);
        subtraction.subtract(lowEnough);
        NaturalNumber one = new NaturalNumber2(1);

        while (subtraction.compareTo(one) > 0) {
            NaturalNumber guessCopy = new NaturalNumber2(guess);
            guessCopy.power(r);
