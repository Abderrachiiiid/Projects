...
public final class NaturalNumberStaticOps {
    ...
    private static String toStringWithCommas(NaturalNumber n) {
        assert n != null : "Violation of: n is not null";
        String result = "";
        NaturalNumber ONE_THOUSAND = new NaturalNumber1L(1000);
        NaturalNumber HUNDERED = new NaturalNumber1L(100);
        NaturalNumber num = n.divide(ONE_THOUSAND);
        if (n.compareTo(HUNDERED) >= 0) {
